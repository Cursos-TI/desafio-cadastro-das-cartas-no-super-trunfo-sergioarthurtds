...
int main()
{
    ...
    pibpercapta1 = (pib1 * 1000000000) / populacao1; //multiplica o PIB por 1 bilhão para ajustar a unidade
    ...
    // Calcula o PIB per Capta Carta 1
    pibpercapta2 = (pib2 * 1000000000) / populacao2; //multiplica o PIB por 1 bilhão para ajustar a unidade
    printf("PIB per Capta: %.2f reais\n", pibpercapta2);
